...
\section{Theoretische Grundlagen}
  \subsection{Herstellung}
    ...
    \begin{figure}[h]
      ...
      \caption{Schematische Darstellung des Aufbaus und der Ausmaße eines $CdSe/ZnS$ Quantenpunktes und seiner Energiestruktur. Entnommen aus \cite{tu_dortmund_versuchsanleitung_nodate-1}}
      \label{fig:NK}
    \end{figure}
