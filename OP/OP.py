...
# plt.plot(P_k, k_x*10**(6), "x", label=r'x-Fallensteifigkeit')
# plt.plot(P_k, k_y*10**(6), "x", label=r'y-Fallensteifigkeit')
# plt.xlabel(r'P [mW]')
...
# 150 |||         {k_B_x_150}         |||  {k_B_y_150}
# 200 |||         {k_B_x_200}         |||  {k_B_y_200}
# 250 |||         {k_B_x_250}         |||  {k_B_y_250}
# 300 |||         {k_B_x_300}         |||  {k_B_y_300}
# 350 |||         {k_B_x_350}         |||  {k_B_y_350}
# """)
